...
@section('title',__('Visualizar Convênio - CRUD Laravel'))
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <table class="w3-table-all notranslate" width="100%" border="1">
                        ...
                        <tr>
                            <th align="left"><strong>@lang('Convênio:')</strong>:</th>
                        ...
                        <tr>
                            <th align="left"><strong>@lang('Site do Convênio:')</strong>:</th>
                        ...
                        <tr>
                            <th align="left"><strong>@lang('perccons_conv??:')</strong>:</th>
                            <th align="left">{{$convenio->perccons_conv}}</th>
                        </tr>
                        <tr>
                            <th align="left"><strong>@lang('percexame_conv:')</strong>:</th>
