@extends('medicos.layout')    <!-- herda o layout do layout.blade -->
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between w-100">
                        <span>@lang('Listagem de Médicos')</span>   <!-- criar uma tela -->
                        <a href="{{ url('medicos/create') }}" class="btn-primary btn-sm"> <!-- caminho do arquivo para esta tela, rota em web.php -> MedicoController.php -> create; Laravel -->
                ...
                <div class="card-body">
                    ...
                    <table class="table table-striped">
                        <thead>
                            <tr>
                                <td>ID</td>
                                <td>@lang('Nome do Médico')</td>
                                <td>@lang('CRM')</td>
                                <td colspan="3" class="text-center">@lang('Ações')</td>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach($medicos as $medico) <!-- vem da function index no Controller -->
                            <tr>
                                <td>{{$medico->id}}</td>
                                <td>{{$medico->nome}}</td>
                                <td>{{$medico->crm}}</td>
