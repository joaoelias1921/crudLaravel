...
@section('title',__('Visualizar Especialidade - CRUD Laravel'))
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <table class="w3-table-all notranslate" width="100%" border="1">
                        ...
                        <tr>
                            <th align="left"><strong>@lang('Especialidade:')</strong>:</th>
                        ...
                        <tr>
                            <th align="left"><strong>@lang('Observações:')</strong>:</th>
